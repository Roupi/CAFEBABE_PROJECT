...
/**
 * INC is the representation of the meta instruction that relate to the direct increment of a local variable by a given value,
 ...
 */
public class INC extends InstructionGen {
    /**
    ...
    /**
     * Constructor of the INC representation
     ...
     */
    public INC(InstructionHandle ih, short opcode, short length, int numberOfRegisters,int maxInsPos, int insNumber, String methName, String classIndex, String methArgs) {
        ...
        if (ih.toString().matches(REGEX_INC)) CONSTRAINTS.add(WV+"1 = "+RV+"1 +"+INSTRUCTION_ARGS[1]);
        else if (ih.toString().matches(REGEX_DEC)) CONSTRAINTS.add(WV+"1 = "+RV+"1 -"+INSTRUCTION_ARGS[1]);
