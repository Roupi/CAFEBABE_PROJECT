...
/**
 * DUP is the representation of the meta instruction that relate to the duplication of the value at the top of the operand stack,
 ...
 */
public class DUP extends InstructionGen {
    /**
     * ID used for the logger
     */
    private static final String id = "com.cafebabe.core.instructions.DUP.";
     ...
     */
    public DUP(InstructionHandle ih, short opcode, short length, int numberOfRegisters,int maxInsPos, int insNumber, String methName, String classIndex, String methArgs) {
