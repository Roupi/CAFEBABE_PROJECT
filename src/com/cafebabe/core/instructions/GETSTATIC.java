...
/**
 * GETSTATIC is the representation of the meta instruction that relate to the act of pushing the static field of an object on the top of the operand stack,
 ...
 */
public class GETSTATIC extends InstructionGen {
    /**
     * ID used for the logger
     */
    private static final String id = "com.cafebabe.core.instructions.GETSTATIC.";
     ...
     */
    public GETSTATIC(InstructionHandle ih, short opcode, short length, int numberOfRegisters,int maxInsPos, int insNumber, String methName, String classIndex, ConstantPool cp, String methArgs) {
        ...
        RM_NBR = 1;
        RM_ARGS = new String[]{ HI,
                                "-" + jarInfo.getClassIndex(INSTRUCTION_ARGS[0]),
                                String.valueOf(jarInfo.getAttributeNumber(INSTRUCTION_ARGS[0],INSTRUCTION_ARGS[1])),
                                FV};
