...
/**
 * GETFIELD is the representation of the meta instruction that relate to the act of pushing the field of an object on the top of the operand stack,
 ...
 */
public class GETFIELD extends InstructionGen {
    /**
     * ID used for the logger
     */
    private static final String id = "com.cafebabe.core.instructions.GETFIELD.";
     ...
     */
    public GETFIELD(InstructionHandle ih, short opcode, short length, int numberOfRegisters,int maxInsPos, int insNumber, String methName, String classIndex, ConstantPool cp, String methArgs) {
