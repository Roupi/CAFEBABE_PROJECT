...
import static com.cafebabe.core.Consts.SP_M1;

/**
 * MUL is the representation of the meta instruction that relate to the multiplication of two values,
 ...
 */
public class MUL extends InstructionGen {
    /**
     * ID used for the logger
     */
    private static final String id = "com.cafebabe.core.instructions.MUL.";

    /**
     * Constructor of the MUL representation
     ...
     */
    public MUL(InstructionHandle ih, short opcode, short length, int numberOfRegisters,int maxInsPos, int insNumber, String methName, String classIndex, String methArgs) {
