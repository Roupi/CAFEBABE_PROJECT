...
/**
 * INVOKESPECIAL is the representation of the meta instruction that relate to the invocation of particular instance method
 ...
 */
public class INVOKESPECIAL extends InstructionGen {
    /**
     * ID used for the logger
     */
    private static final String id = "com.cafebabe.core.instructions.INVOKESPECIAL.";

    /**
     * Constructor of the INVOKESPECIAL representation
     ...
     */
    public INVOKESPECIAL(InstructionHandle ih, short opcode, short length, int numberOfRegisters,int maxInsPos, int insNumber, String methName, String classIndex, ConstantPool cp, String methArgs) {
        ...
        nreads = jarInfo.getMthdNbrArg(INSTRUCTION_ARGS[0], INSTRUCTION_ARGS[1],INSTRUCTION_ARGS[2]) + 1; //must read objectref plus input args
        ...
        //Init constraints..
        int nbrArgs = jarInfo.getMthdNbrArg(CALLS_INFOS[0], INSTRUCTION_ARGS[1],INSTRUCTION_ARGS[2]) + 1; //+1 for implicit objectref
        int j = 0;
