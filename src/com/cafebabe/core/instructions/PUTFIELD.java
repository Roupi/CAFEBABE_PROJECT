...
/**
 * PUTFIELD is the representation of the meta instruction that relate to the act of setting a value in a field of an object present in the memory,
 ...
 */
public class PUTFIELD extends InstructionGen {
    /**
    ...
    /**
     * Constructor of the PUTFIELD representation
     ...
     */
    public PUTFIELD(InstructionHandle ih, short opcode, short length, int numberOfRegisters,int maxInsPos, int insNumber, String methName, String classIndex, ConstantPool cp, String methArgs) {
