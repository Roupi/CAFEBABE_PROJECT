...
import static com.cafebabe.core.Consts.REGEX_GOTO;
import static com.cafebabe.core.Consts.SP;
import static com.cafebabe.core.Consts.SPN;

/**
 * GOTO is the representation of the meta instruction that relate to the act of redirecting the control flow towards a given instruction,
 ...
 */
public class GOTO extends InstructionGen {
    /**
     * ID used for the logger
     */
    private static final String id = "com.cafebabe.core.instructions.GOTO.";
     ...
     */
    public GOTO(InstructionHandle ih, short opcode, short length, int numberOfRegisters,int maxInsPos, int insNumber, String methName, String classIndex,String methArgs) {
