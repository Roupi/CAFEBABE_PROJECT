...
/**
 * SUB is the representation of the meta instruction that relate to the subtraction of two values,
 ...
 */
public class SUB extends InstructionGen {
    /**
     * ID used for the logger
     */
    private static final String id = "com.cafebabe.core.instructions.SUB.";

    /**
     * Constructor of the SUB representation
     *
     ...
     */
    public SUB(InstructionHandle ih, short opcode, short length, int numberOfRegisters,int maxInsPos, int insNumber, String methName, String classIndex, String methArgs) {
