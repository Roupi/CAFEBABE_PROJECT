...
%   0: iconst_5[8](1)
p1_2_0(IV0,IV1,IV2,IV3,NV0,NV1,NV2,NV3,SP_INDEX,IHS,OHS,HI,HO,R) :-
         {WRITE_VALUE_1 = 5,SP_INDEX_NEW = SP_INDEX  + 1,WRITE_INDEX_1 = SP_INDEX  + 1,SP_INDEX = 1,IV0 = 0,IV1 = 0,IV2 = 0,IV3 = 0},
...
p1_2_3(IV0,IV1,IV2,IV3,NV0,NV1,NV2,NV3,SP_INDEX,IHS,OHS,HI,HO,R) :-
         ...
         read_2(READ_INDEX_1,IV0,IV1,IV2,IV3,READ_VALUE_1),
         write_2(WRITE_INDEX_1,IV0,IV1,IV2,IV3,OV0,OV1,OV2,OV3,WRITE_VALUE_1),
         p1_2_4(OV0,OV1,OV2,OV3,NV0,NV1,NV2,NV3,SP_INDEX_NEW,IHS,OHS,HI,HO,R).
%   5: iload_0[26](1)
p1_2_4(IV0,IV1,IV2,IV3,NV0,NV1,NV2,NV3,SP_INDEX,IHS,OHS,HI,HO,R) :-
         {READ_INDEX_1 = 0,WRITE_VALUE_1 = READ_VALUE_1,WRITE_INDEX_1 = SP_INDEX  + 1,SP_INDEX_NEW = SP_INDEX  + 1},
         read_2(READ_INDEX_1,IV0,IV1,IV2,IV3,READ_VALUE_1),
         write_2(WRITE_INDEX_1,IV0,IV1,IV2,IV3,OV0,OV1,OV2,OV3,WRITE_VALUE_1),
         p1_2_5(OV0,OV1,OV2,OV3,NV0,NV1,NV2,NV3,SP_INDEX_NEW,IHS,OHS,HI,HO,R).
%   6: iload_1[27](1)
p1_2_5(IV0,IV1,IV2,IV3,NV0,NV1,NV2,NV3,SP_INDEX,IHS,OHS,HI,HO,R) :-
         {READ_INDEX_1 = 1,WRITE_VALUE_1 = READ_VALUE_1,WRITE_INDEX_1 = SP_INDEX  + 1,SP_INDEX_NEW = SP_INDEX  + 1},
         read_2(READ_INDEX_1,IV0,IV1,IV2,IV3,READ_VALUE_1),
         write_2(WRITE_INDEX_1,IV0,IV1,IV2,IV3,OV0,OV1,OV2,OV3,WRITE_VALUE_1),
         p1_2_6(OV0,OV1,OV2,OV3,NV0,NV1,NV2,NV3,SP_INDEX_NEW,IHS,OHS,HI,HO,R).
%   7: iadd[96](1)
p1_2_6(IV0,IV1,IV2,IV3,NV0,NV1,NV2,NV3,SP_INDEX,IHS,OHS,HI,HO,R) :-
         ...
         write_2(WRITE_INDEX_1,IV0,IV1,IV2,IV3,OV0,OV1,OV2,OV3,WRITE_VALUE_1),
         p1_2_7(OV0,OV1,OV2,OV3,NV0,NV1,NV2,NV3,SP_INDEX_NEW,IHS,OHS,HI,HO,R).
%   8: ireturn[172](1)
p1_2_7(IV0,IV1,IV2,IV3,NV0,NV1,NV2,NV3,SP_INDEX,IHS,OHS,HI,HO,R) :-
         {IV0 = NV0,IV1 = NV1,IV2 = NV2,IV3 = NV3,READ_INDEX_1 = SP_INDEX,R = READ_VALUE_1,IHS = OHS,unify(HI,HO)},
         read_2(READ_INDEX_1,IV0,IV1,IV2,IV3,READ_VALUE_1)
.
%READ AND WRITE PREDICATES OF:add()I
