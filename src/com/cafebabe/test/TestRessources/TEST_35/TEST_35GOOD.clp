p_start(IV0,R) :-
         {IHS = 0},
         p2_1_0(IV0,IV1,IV2,IV3,IV4,IV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX,IHS,OHS,R).
...
p1_1_0(IV0,IV1,IV2,NV0,NV1,NV2,IM,OM,SP_INDEX,IHS,OHS,R) :-
         {SP_INDEX = 0,IV1 = 0,IV2 = 0,IM=0,OM=0,WRITE_VALUE_1 = 18,SP_INDEX_NEW = SP_INDEX + 1, WRITE_INDEX_1 = SP_INDEX + 1},
         write_1(WRITE_INDEX_1,IV0,IV1,IV2,OV0,OV1,OV2,WRITE_VALUE_1),
         p1_1_1(OV0,OV1,OV2,NV0,NV1,NV2,IM,OM,SP_INDEX_NEW,IHS,OHS,R).
%   2: aload_0[42](1)
...
p1_1_2(IV0,IV1,IV2,NV0,NV1,NV2,IM,OM,SP_INDEX,IHS,OHS,R) :-
         ...
         p1_1_3(OV0,OV1,OV2,NV0,NV1,NV2,IM,OM,SP_INDEX_NEW,IHS,OHS,R).
%   6: iadd[96](1)
p1_1_3(IV0,IV1,IV2,NV0,NV1,NV2,IM,OM,SP_INDEX,IHS,OHS,R) :-
         ...
         write_1(WRITE_INDEX_1,IV0,IV1,IV2,OV0,OV1,OV2,WRITE_VALUE_1),
         p1_1_4(OV0,OV1,OV2,NV0,NV1,NV2,IM,OM,SP_INDEX_NEW,IHS,OHS,R).
%   7: ireturn[172](1)
p1_1_4(IV0,IV1,IV2,NV0,NV1,NV2,IM,OM,SP_INDEX,IHS,OHS,R) :-
...
p2_1_0(IV0,IV1,IV2,IV3,IV4,IV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX,IHS,OHS,R) :-
         ...
         writeMemory(IHS,1,0),
         writeMemory(IHS,0,1),
         p2_1_1(OV0,OV1,OV2,OV3,OV4,OV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX_NEW,IHS_NEW,OHS,R).
%   3: dup[89](1)
p2_1_1(IV0,IV1,IV2,IV3,IV4,IV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX,IHS,OHS,R) :-
         ...
         write_1(WRITE_INDEX_1,IV0,IV1,IV2,IV3,IV4,IV5,OV0,OV1,OV2,OV3,OV4,OV5,WRITE_VALUE_1),
         p2_1_2(OV0,OV1,OV2,OV3,OV4,OV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX_NEW,IHS,OHS,R).
%   4: invokespecial[183](3) 3
p2_1_2(IV0,IV1,IV2,IV3,IV4,IV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX,IHS,OHS,R) :-
...
,
         ...
         p2_1_3(IV0,IV1,IV2,IV3,IV4,IV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX_NEW,OHS_CALL,OHS,R).
%   7: astore_1[76](1)
p2_1_3(IV0,IV1,IV2,IV3,IV4,IV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX,IHS,OHS,R) :-
         {READ_INDEX_1 = SP_INDEX,WRITE_VALUE_1 = READ_VALUE_1 ,WRITE_INDEX_1 = 1, SP_INDEX_NEW = SP_INDEX -1},
         read_1(READ_INDEX_1,IV0,IV1,IV2,IV3,IV4,IV5,READ_VALUE_1),
         write_1(WRITE_INDEX_1,IV0,IV1,IV2,IV3,IV4,IV5,OV0,OV1,OV2,OV3,OV4,OV5,WRITE_VALUE_1),
         p2_1_4(OV0,OV1,OV2,OV3,OV4,OV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX_NEW,IHS,OHS,R).
%   8: aload_1[43](1)
p2_1_4(IV0,IV1,IV2,IV3,IV4,IV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX,IHS,OHS,R) :-
         {READ_INDEX_1 =1, WRITE_VALUE_1 = READ_VALUE_1, SP_INDEX_NEW = SP_INDEX + 1, WRITE_INDEX_1 = SP_INDEX + 1},
         read_1(READ_INDEX_1,IV0,IV1,IV2,IV3,IV4,IV5,READ_VALUE_1),
         write_1(WRITE_INDEX_1,IV0,IV1,IV2,IV3,IV4,IV5,OV0,OV1,OV2,OV3,OV4,OV5,WRITE_VALUE_1),
         p2_1_5(OV0,OV1,OV2,OV3,OV4,OV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX_NEW,IHS,OHS,R).
%   9: invokevirtual[182](3) 4
p2_1_5(IV0,IV1,IV2,IV3,IV4,IV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX,IHS,OHS,R) :-
         {WRITE_VALUE_1=READ_VALUE_1,WRITE_VALUE_2=0,WRITE_VALUE_3=0
         ,READ_INDEX_1= SP_INDEX-0
         ...
         p2_1_6(OV0,OV1,OV2,OV3,OV4,OV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX_NEW,OHS_CALL,OHS,R).
p2_1_5(IV0,IV1,IV2,IV3,IV4,IV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX,IHS,OHS,R) :-
         {WRITE_VALUE_1=READ_VALUE_1,WRITE_VALUE_2=0,WRITE_VALUE_3=0
         ,READ_INDEX_1= SP_INDEX-0
         ,SP_INDEX_NEW = SP_INDEX -0,
         ...
         p2_1_6(OV0,OV1,OV2,OV3,OV4,OV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX_NEW,OHS_CALL,OHS,R).
%  12: istore_2[61](1)
p2_1_6(IV0,IV1,IV2,IV3,IV4,IV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX,IHS,OHS,R) :-
         {READ_INDEX_1 = SP_INDEX,WRITE_VALUE_1 = READ_VALUE_1 ,WRITE_INDEX_1 = 2, SP_INDEX_NEW = SP_INDEX -1},
         read_1(READ_INDEX_1,IV0,IV1,IV2,IV3,IV4,IV5,READ_VALUE_1),
         write_1(WRITE_INDEX_1,IV0,IV1,IV2,IV3,IV4,IV5,OV0,OV1,OV2,OV3,OV4,OV5,WRITE_VALUE_1),
         p2_1_7(OV0,OV1,OV2,OV3,OV4,OV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX_NEW,IHS,OHS,R).
%VARIABLE INITIALISATION PATTERN {  13: iconst_5[8](1) ->  14: istore_3[62](1)   }
p2_1_7(IV0,IV1,IV2,IV3,IV4,IV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX,IHS,OHS,R) :-
         {},
         p2_1_9(IV0,IV1,IV2,5,IV4,IV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX_NEW,IHS,OHS,R).
%  15: return[177](1)
p2_1_9(IV0,IV1,IV2,IV3,IV4,IV5,NV0,NV1,NV2,NV3,NV4,NV5,IM,OM,SP_INDEX,IHS,OHS,R) :-
...
%END OF METHOD:<init>()V
%NO CODE FOR INTERFACE METHODS%END OF METHOD:giveNumber()I
%METHOD:add(II)I
%   0: iload_1[27](1)
p3_2_0(IV0,IV1,IV2,IV3,IV4,NV0,NV1,NV2,NV3,NV4,IM,OM,SP_INDEX,IHS,OHS,R) :-
         {SP_INDEX = 2,IV3 = 0,IV4 = 0,IM=0,OM=0,READ_INDEX_1 =1, WRITE_VALUE_1 = READ_VALUE_1, SP_INDEX_NEW = SP_INDEX + 1, WRITE_INDEX_1 = SP_INDEX + 1},
...
p3_2_3(IV0,IV1,IV2,IV3,IV4,NV0,NV1,NV2,NV3,NV4,IM,OM,SP_INDEX,IHS,OHS,R) :-
         {IV0= NV0,IV1= NV1,IV2= NV2,IV3= NV3,IV4= NV4,READ_INDEX_1 = SP_INDEX, R = READ_VALUE_1,OHS = IHS},
         read_2(READ_INDEX_1,IV0,IV1,IV2,IV3,IV4,READ_VALUE_1).
