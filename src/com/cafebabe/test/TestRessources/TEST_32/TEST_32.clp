...
,
         p1_1_8(OV0,OV1,OV2,OV3,OV4,NV0,NV1,NV2,NV3,NV4,SP_INDEX_NEW,OHS_CALL,OHS,HO_NEW,HO,R).
%  16: istore_1[60](1)
...
p2_1_0(IV0,IV1,NV0,NV1,SP_INDEX,IHS,OHS,HI,HO,R) :-
         {WRITE_VALUE_1 = 93,SP_INDEX_NEW = SP_INDEX  + 1,WRITE_INDEX_1 = SP_INDEX  + 1,SP_INDEX = 0,IV1 = 0},
